...
def load_checkpoint(prefix, epoch):
    """
    Load transformer checkpoint from file.
    :param prefix: Prefix of transformer name.
    :param epoch: Epoch number of transformer we would like to load.
...
def load_param(prefix, epoch, convert=False, ctx=None, process=False):
    ...
    :param prefix: Prefix of transformer name.
    :param epoch: Epoch number of transformer we would like to load.
    :param convert: reference transformer should be converted to GPU NDArray first
    :param ctx: if convert then ctx must be designated.
    :param process: transformer should drop any test
    :return: (arg_params, aux_params)
    """
