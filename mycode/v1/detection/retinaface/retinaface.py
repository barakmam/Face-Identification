...
import cv2
from mycode.v1.detection.retinaface.rcnn.logger import logger
from mycode.v1.detection.retinaface.rcnn.processing.bbox_transform import clip_boxes
from mycode.v1.detection.retinaface.rcnn.processing.generate_anchor import generate_anchors_fpn, anchors_plane
from mycode.v1.detection.retinaface.rcnn.processing.nms import gpu_nms_wrapper, cpu_nms_wrapper
from mycode.v1.detection.retinaface.rcnn.processing.bbox_transform import bbox_overlaps
        ...
        for img in imgs:
            for im_scale in scales:
                for flip in flips:
                    ...
                    #self.transformer.bind(data_shapes=[('data', (1, 3, image_size[0], image_size[1]))], for_training=False)
