...
def train_net(args,
    ...
    def _batch_callback(param):
        ...
        if mbatch == lr_steps[-1][0]:
            ...
            save_model(0)
            #arg, aux = mod.get_params()
            #mx.transformer.save_checkpoint(prefix, 99, mod.symbol, arg, aux)
            sys.exit(0)
