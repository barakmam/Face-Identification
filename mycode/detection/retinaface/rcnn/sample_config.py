...
network.mnet = edict()
#network.mnet.pretrained = 'transformer/mnasnet'
#network.mnet.pretrained = 'transformer/mobilenetv2_0_5'
#network.mnet.pretrained = 'transformer/mobilenet_0_5'
#network.mnet.MULTIPLIER = 0.5
#network.mnet.pretrained = 'transformer/mobilenet_0_25'
...
#network.mnet.pretrained = 'transformer/mobilenetfd_0_25' #78
#network.mnet.pretrained = 'transformer/mobilenetfd2' #75
network.mnet.pretrained = 'transformer/mobilenet025fd0'  #78
#network.mnet.pretrained = 'transformer/mobilenet025fd1' #75
#network.mnet.pretrained = 'transformer/mobilenet025fd2' #
network.mnet.pretrained_epoch = 0
...
#network.resnet.pretrained = 'transformer/ResNet50_v1d'
#network.resnet.pretrained = 'transformer/resnet-50'
network.resnet.pretrained = 'transformer/resnet-152'
#network.resnet.pretrained = 'transformer/senet154'
#network.resnet.pretrained = 'transformer/densenet161'
...
default.pretrained = 'transformer/resnet-152'
...
# default e2e
default.prefix = 'transformer/retinaface'
